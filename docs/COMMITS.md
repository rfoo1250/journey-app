...
This document dedicates to doing commits and messages with good practice. This concern was raised when tags "STABLE" & "UNSTABLE" was used, outside of standard practice. On 2/6/2026 this repository will align with industry standard, but with "STABLE" remaining. Also, per <cite>[[2]](#ref-panop)</cite>, the commits here would also be numbered by order/count. 
...
(probably don't need to be numbered)
